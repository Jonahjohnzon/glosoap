    ...
    <img src='/bgwhite.png' className=' absolute -right-40 xl:-left-[500px] block w-[900px] dark:hidden'/>
      <div className=" flex justify-center pt-28 pb-10 relative z-20">
        ...
        >
          ...
          <div className=' dark:border-white border-black border-[1px] h-fit w-fit rounded-2xl overflow-hidden'><div className=' overflow-hidden dark:border-white border-black border-[1px] h-fit w-fit rounded-2xl  m-2'><img alt='glosoap' src='/main.png' className=' w-28 h-28 sm:w-40 sm:h-40 xl:w-80 xl:h-80'/></div></div>
          </div>
        </motion.div>
      </div>
      {/* buttom design*/}
